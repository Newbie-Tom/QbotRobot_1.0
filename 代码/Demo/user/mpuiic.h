...
#define MPU_SDA_IN()  {GPIOA->CRL&=0XFFFFF0FF;GPIOA->CRL|=8<<8;}
#define MPU_SDA_OUT() {GPIOA->CRL&=0XFFFFF0FF;GPIOA->CRL|=3<<8;}
...
#define MPU_IIC_SCL    PAout(3) 		//SCL
#define MPU_IIC_SDA    PAout(2) 		//SDA	 
#define MPU_READ_SDA   PAin(2) 		//输入SDA 
